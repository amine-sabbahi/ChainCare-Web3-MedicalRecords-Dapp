...
const SideBarAdmin = ({children}) => {
  ...
  const navigationItems = [
    {icon: <LayoutDashboard className="w-5 h-5"/>, label: 'Admin Panel', href: '/admin'},
    {icon: <Users className="w-5 h-5"/>, label: 'Patients Panel', href: '/admin/createPatient'},
    {icon: <Stethoscope className="w-5 h-5"/>, label: 'Doctors Panel', href: '/admin/createDoctor'},
  ];
